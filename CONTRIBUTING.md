# Contributing to ml-analytics-dashboard-ng

ml-analytics-dashboard-ng welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-analytics-dashboard-ng, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **ml-analytics-dashboard-ng Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/patrickmcelwee/ml-analytics-dashboard-ng/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-analytics-dashboard-ng.git
$ cd ml-analytics-dashboard-ng
$ git remote add upstream git://github.com/patrickmcelwee/ml-analytics-dashboard-ng.git
$ git fetch upstream
```
...
Go to https://github.com/username/ml-analytics-dashboard-ng and select your feature branch. Click
...
[wiki]: https://github.com/patrickmcelwee/ml-analytics-dashboard-ng/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/patrickmcelwee/ml-analytics-dashboard-ng/issues
