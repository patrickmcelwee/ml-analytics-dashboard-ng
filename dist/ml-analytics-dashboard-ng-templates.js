...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/templates/designer.html',
    '<div class="row"><div class="col-md-12"><span class="view-title">{{report.name}}</span><p>{{report.description}}</p><div dashboard="reportDashboardOptions" template-url="/templates/dashboard-content.html"></div></div></div>');
}]);
})();
