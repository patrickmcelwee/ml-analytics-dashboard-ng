...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/templates/designer.html',
    '<div class="row"><div class="col-md-12"><a ui-sref="root.analytics-dashboard.home" class="btn btn-small btn-link"><< All Reports</a><h2 class="view-title">{{report.name}}</h2><p>{{report.description}}</p><div dashboard="reportDashboardOptions" template-url="/templates/dashboard-content.html"></div></div></div>');
}]);
})();
